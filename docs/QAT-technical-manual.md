...
Please refer to [this folder](Process%20Flows) for additional information on process flows.
...
<https://github.com/HSS-FASP-Team/fasp-core-ui/> (Client-side project for QAT)
