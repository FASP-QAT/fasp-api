...
public class PlanningUnitDaoImpl implements PlanningUnitDao {
    ...
    public int updatePlanningUnit(PlanningUnit planningUnit, CustomUserDetails curUser) throws DuplicateNameException {
        ...
        (boolean active, CustomUserDetails curUser
        ...
        @Override
        public List<PlanningUnit> getPlanningUnitListByIds
        (List<String> planningUnitIdList, CustomUserDetails curUser
        ...
        @Override
        public List<PlanningUnitWithPrices> getPlanningUnitListWithPricesByIds
        (List<String> planningUnitIdList, CustomUserDetails curUser
        ...
        @Override
        public List<PlanningUnit> getPlanningUnitList
        (int realmId, boolean active, CustomUserDetails curUser
        ...
        @Override
        public List<SimplePlanningUnitForAdjustPlanningUnit> getPlanningUnitListBasic
        ...
        @Override
        public List<PlanningUnit> getPlanningUnitListByForecastingUnit
        (int forecastingUnitId, boolean active, CustomUserDetails curUser
        ...
        @Override
        public PlanningUnit getPlanningUnitById
        (int planningUnitId, CustomUserDetails curUser
        ...
        @Override
        public List<PlanningUnitCapacity> getPlanningUnitCapacityList
        (CustomUserDetails curUser
        ...
        @Override
        public List<PlanningUnitCapacity> getPlanningUnitCapacityForRealm
        (int realmId, String startDate
        ...
        @Override
        public List<PlanningUnitCapacity> getPlanningUnitCapacityForId
        (int planningUnitId, String startDate
        , String stopDate, CustomUserDetails curUser
        ...
        @Override
        public int savePlanningUnitCapacity
        (PlanningUnitCapacity[] planningUnitCapacitys, CustomUserDetails curUser
        ...
        @Override
        public List<PlanningUnit> getPlanningUnitListForSync
        (String lastSyncDate, CustomUserDetails curUser
        ...
        @Override
        public List<PlanningUnit> getPlanningUnitListForSyncProgram
        (String programIdsString, CustomUserDetails curUser
        ...
        @Override
        public List<PlanningUnit> getPlanningUnitListForProductCategory
        (String productCategorySortOrder, boolean active, CustomUserDetails curUser
        ...
        @Override
        public List<SimpleObject> getPlanningUnitListForProductCategoryList
        (String[] productCategoryIds, boolean active, CustomUserDetails curUser
        ...
        @Override
        public List<SimpleObject> getPlanningUnitListByRealmCountryId
        (int realmCountryId, CustomUserDetails curUser
        ...
        @Override
        public List<SimpleObject> getPlanningUnitByProgramAndTracerCategory
        (MultipleProgramAndTracerCategoryDTO programAndTracerCategory, CustomUserDetails curUser
        ...
        @Override
        public List<SimpleObject> getPlanningUnitListByTracerCategory
        (int tracerCategoryId, boolean active, CustomUserDetails curUser
        ...
        @Override
        public List<PlanningUnit> getPlanningUnitListByTracerCategoryIds
        (String[] tracerCategoryIds, boolean active, CustomUserDetails curUser
        ...
        @Override
        public List<SimplePlanningUnitWithPrices> getPlanningUnitListWithPricesForProductCategory
        (int productCategoryId, CustomUserDetails curUser
...
//        params.put("programId", programId);
        ...
        @Override
        public List<SimpleObject> getPlanningUnitListForAutoComplete
        (AutoCompleteInput autoCompleteInput, CustomUserDetails curUser
        ...
        @Override
        public List<SimpleObject> getPlanningUnitListForAutoCompleteFilterForProductCategory
        (AutocompleteInputWithProductCategoryDTO autoCompleteInput, CustomUserDetails curUser
        
            ) {
        StringBuilder stringBuilder = new StringBuilder("SELECT pu.PLANNING_UNIT_ID `ID`, pu.LABEL_ID, pu.LABEL_EN, pu.LABEL_FR, pu.LABEL_SP, pu.LABEL_PR FROM vw_planning_unit pu LEFT JOIN rm_forecasting_unit fu on fu.FORECASTING_UNIT_ID=pu.FORECASTING_UNIT_ID LEFT JOIN rm_product_category pc ON fu.PRODUCT_CATEGORY_ID=pc.PRODUCT_CATEGORY_ID WHERE pu.ACTIVE AND fu.ACTIVE AND (COALESCE(pu.LABEL_").append(autoCompleteInput.getLanguage()).append(",pu.LABEL_EN) LIKE CONCAT('%',:searchText,'%') OR pu.PLANNING_UNIT_ID LIKE CONCAT('%',:searchText,'%')) ");
            Map<String, Object> params = new HashMap<>();
            params.put("searchText", autoCompleteInput.getSearchText());
            this.aclService.addUserAclForRealm(stringBuilder, params, "fu", curUser);
        ...
        @Override
        public List<SimpleObject> getPlanningUnitDropDownList
        (CustomUserDetails curUser
        ...
        @Override
        public List<SimpleObject> getPlanningUnitDropDownListFilterProductCategory
        (String productCategorySortOrder, CustomUserDetails curUser
        ...
        @Override
        public List<SimpleObject> getPlanningUnitForDatasetByProgramAndVersion
        (ProgramAndVersionDTO input, CustomUserDetails curUser
