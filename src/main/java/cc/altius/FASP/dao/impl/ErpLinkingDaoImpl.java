...
//        }
    ...
    public List<ShipmentLinkingOutput> getLinkedQatShipments(int programId, int versionId, String[] planningUnitIds, CustomUserDetails curUser) {
        StringBuilder sqlStringBuilder = new StringBuilder("SELECT "
                + "                    e.`RO_NO`, e.RO_PRIME_LINE_NO, e.STATUS `ERP_SHIPMENT_STATUS`, e.`ACTIVE` `ORDER_ACTIVE`, "
                + "                    e.ORDER_NO, e.PRIME_LINE_NO, e.QTY `ERP_QTY`, "
                ...
                + "                LEFT JOIN rm_erp_order_consolidated e  ON sl.RO_NO=e.RO_NO AND sl.RO_PRIME_LINE_NO=e.RO_PRIME_LINE_NO and sl.ORDER_NO=e.ORDER_NO and sl.PRIME_LINE_NO=e.PRIME_LINE_NO"
                + "                LEFT JOIN rm_shipment_linking_trans slt ON slt.SHIPMENT_LINKING_ID=sl.SHIPMENT_LINKING_ID AND slt.VERSION_ID=sl.MAX_VERSION_ID AND slt.ACTIVE "
                ...
                + "                LEFT JOIN rm_program_planning_unit ppu ON ppu.PROGRAM_ID=p.PROGRAM_ID AND ppu.PLANNING_UNIT_ID=papu.PLANNING_UNIT_ID "
