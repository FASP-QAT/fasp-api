...
public class UnitDaoImpl implements UnitDao {
    ...
    public List<Unit> getUnitListForSync(String lastSyncDate) {
        String sqlString = this.sqlListString + " AND u.LAST_MODIFIED_DATE>=:lastSyncDate";
        Map<String, Object> params = new HashMap<>();
    ...
    public List<Unit> getUnitList() {
        ...
        return this.namedParameterJdbcTemplate.query(sqlString, new UnitRowMapper());
    }

    @Override
    public Unit getUnitById(int unitId) {
        String sqlString = this.sqlListString + " AND u.UNIT_ID=:unitId";
        Map<String, Object> params = new HashMap<>();
        params.put("unitId", unitId);
        return this.namedParameterJdbcTemplate.queryForObject(sqlString, params, new UnitRowMapper());
    }
