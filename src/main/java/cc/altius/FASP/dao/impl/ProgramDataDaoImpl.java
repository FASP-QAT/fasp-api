...
//        return this.jdbcTemplate.queryForObject(sql, new PrgProgramDataDTORowMapper());
    ...
    public List<PrgConsumptionDTO> getConsumptionListByProductId(int productId) {
        String sql = "SELECT i.`CONSUMPTION_ID`,i.`CONSUMPTION_QTY`,i.`DATA_SOURCE_ID`,adst.`DATA_SOURCE_TYPE_ID`,\n"
                ...
                + "consumption_unit.`UNIT_TYPE_ID` AS UNIT_TYPE_ID,cpul.`LABEL_EN` AS `LU_PLANNING_UNIT_NAME_EN`,\n"
                + "cpul.`LABEL_FR` AS `LU_PLANNING_UNIT_NAME_FR`,cpul.`LABEL_PR` AS `LU_PLANNING_UNIT_NAME_PR`,\n"
                + "cpul.`LABEL_SP` AS `LU_PLANNING_UNIT_NAME_SP`,cpu.`PLANNING_UNIT_ID` AS `LU_PLANNING_UNIT_ID`,cpu.`PRICE` AS `	LU_PRICE`,cpu.`QTY_OF_FORECASTING_UNITS` AS `LU_QTY_OF_FORECASTING_UNITS`,\n"
                + "cpuu_label.`LABEL_EN` AS `LU_PLANNING_UNIT_UNIT_NAME_EN`,cpuu_label.`LABEL_FR` AS `LU_PLANNING_UNIT_UNIT_NAME_FR`,\n"
                + "cpuu_label.`LABEL_PR` AS `LU_PLANNING_UNIT_UNIT_NAME_PR`,cpuu_label.`LABEL_SP` AS `LU_PLANNING_UNIT_UNIT_NAME_SP`\n"
                + ",cpu_unit.`UNIT_CODE` AS `LU_PLANNING_UNIT_UNIT_CODE`,cpu_unit.`UNIT_ID` AS `LU_PLANNING_UNIT_UNIT_ID`\n"
                + ",cpuut_label.`LABEL_EN` AS `LU_PLANNING_UNIT_UNIT_TYPE_NAME_EN`,cpuut_label.`LABEL_FR` AS `LU_PLANNING_UNIT_UNIT_TYPE_NAME_FR`\n"
                + ",cpuut_label.`LABEL_SP` AS `LU_PLANNING_UNIT_UNIT_TYPE_NAME_SP`,cpuut_label.`LABEL_PR` AS `LU_PLANNING_UNIT_UNIT_TYPE_NAME_PR`,\n"
