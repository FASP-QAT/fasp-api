...
//            params.put("ACTIVE", true);
        ...
        Version version = this.namedParameterJdbcTemplate.queryForObject("CALL getVersionId(:programId, :versionTypeId, :versionStatusId, :notes, null, null, null, :curUser, :curDate)", params, new VersionRowMapper());
