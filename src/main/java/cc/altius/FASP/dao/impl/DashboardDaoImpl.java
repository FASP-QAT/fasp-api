...
public class DashboardDaoImpl implements DashboardDao {
    ...
    public List<DashboardTop> getDashboardTop(String[] programIds, CustomUserDetails curUser) {
        StringBuilder sqlBuilder = new StringBuilder("SELECT "
                ...
                + "    vs1.VERSION_STATUS_ID AS FINAL_VERSION_STATUS_ID, vs.LABEL_ID `FINAL_VS_LABEL_ID`, vs.LABEL_EN `FINAL_VS_LABEL_EN`, vs.LABEL_FR `FINAL_VS_LABEL_FR`, vs.LABEL_SP `FINAL_VS_LABEL_SP`, vs.LABEL_PR `FINAL_VS_LABEL_PR`, "
                + "    p.CURRENT_VERSION_ID AS VERSION_ID,pv2.LAST_MODIFIED_DATE AS FINAL_VERSION_LAST_MODIFIED_DATE,  "
