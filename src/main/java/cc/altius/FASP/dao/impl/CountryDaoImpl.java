...
public class CountryDaoImpl implements CountryDao {
    ...
    public List<Country> getCountryListForSync(String lastSyncDate) {
        String sqlString = this.sqlListString + " AND c.LAST_MODIFIED_DATE>=:lastSyncDate";
        Map<String, Object> params = new HashMap<>();
    ...
    public Country getCountryById(int countryId, CustomUserDetails curUser) {
        String sqlString = this.sqlListString + " AND c.COUNTRY_ID=:countryId";
        Map<String, Object> params = new HashMap<>();
