...
public class ProcurementAgentDaoImpl implements ProcurementAgentDao {
    ...
    private String sqlListString = " SELECT pa.PROCUREMENT_AGENT_ID, pa.PROCUREMENT_AGENT_CODE, pa.COLOR_HTML_CODE, pa.SUBMITTED_TO_APPROVED_LEAD_TIME, pa.LOCAL_PROCUREMENT_AGENT, "
