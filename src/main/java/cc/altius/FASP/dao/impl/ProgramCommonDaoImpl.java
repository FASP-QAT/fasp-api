...
public class ProgramCommonDaoImpl implements ProgramCommonDao {
    ...
    public static final String SQL_SIMPLE_PROGRAM_STRING = "SELECT "
            ...
            + "	p.CURRENT_VERSION_ID, p.ACTIVE, p.PROGRAM_TYPE_ID, rc.REALM_ID,coalesce(p.NO_OF_MONTHS_IN_PAST_FOR_BOTTOM_DASHBOARD,rm_realm.NO_OF_MONTHS_IN_PAST_FOR_BOTTOM_DASHBOARD) `NO_OF_MONTHS_IN_PAST_FOR_BOTTOM_DASHBOARD`, coalesce(p.NO_OF_MONTHS_IN_FUTURE_FOR_BOTTOM_DASHBOARD,rm_realm.NO_OF_MONTHS_IN_FUTURE_FOR_BOTTOM_DASHBOARD) `NO_OF_MONTHS_IN_FUTURE_FOR_BOTTOM_DASHBOARD`  "
