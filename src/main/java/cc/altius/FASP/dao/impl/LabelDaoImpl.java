...
public class LabelDaoImpl implements LabelDao {
    ...
    public List<DatabaseTranslationsDTO> getDatabaseLabelsList(int realmId) {
        String sql = "select * from (SELECT l.LABEL_ID,l.LABEL_EN,l.LABEL_FR,l.LABEL_PR,l.LABEL_SP, \n"
                ...
                + "union \n"
                + "SELECT l.LABEL_ID,l.LABEL_EN,l.LABEL_FR,l.LABEL_PR,l.LABEL_SP, \n"
                + "-1 as `REALM_ID`,'static.dataSource.dataSourceName' as `LABEL_FOR` \n"
                + "FROM fasp.ap_data_source c \n"
                + "left join ap_label l on l.LABEL_ID=c.LABEL_ID\n"
                + "union \n"
                + "SELECT l.LABEL_ID,l.LABEL_EN,l.LABEL_FR,l.LABEL_PR,l.LABEL_SP, \n"
                + "-1 as `REALM_ID`,'static.dataSourceType.dataSourceTypeName' as `LABEL_FOR` \n"
                + "FROM fasp.ap_data_source_type c \n"
                + "left join ap_label l on l.LABEL_ID=c.LABEL_ID\n"
                + "union \n"
                + "SELECT l.LABEL_ID,l.LABEL_EN,l.LABEL_FR,l.LABEL_PR,l.LABEL_SP, \n"
                ...
                + "union \n"
                + "SELECT l.LABEL_ID,l.LABEL_EN,l.LABEL_FR,l.LABEL_PR,l.LABEL_SP, \n"
                + "-1 as `REALM_ID`,'static.unitType.unitTypeName' as `LABEL_FOR` \n"
                + "FROM fasp.ap_unit_type c \n"
                + "left join ap_label l on l.LABEL_ID=c.LABEL_ID\n"
                + "union \n"
                + "SELECT l.LABEL_ID,l.LABEL_EN,l.LABEL_FR,l.LABEL_PR,l.LABEL_SP, \n"
                ...
                + "union \n"
                + "SELECT l.LABEL_ID,l.LABEL_EN,l.LABEL_FR,l.LABEL_PR,l.LABEL_SP, \n"
                + "c.`REALM_ID` as `REALM_ID`,'static.manufacturer.manufacturerName' as `LABEL_FOR` \n"
                + "FROM fasp.rm_manufacturer c \n"
                + "left join ap_label l on l.LABEL_ID=c.LABEL_ID\n"
                + "union \n"
                + "SELECT l.LABEL_ID,l.LABEL_EN,l.LABEL_FR,l.LABEL_PR,l.LABEL_SP, \n"
                ...
                + "union \n"
                + "SELECT l.LABEL_ID,l.LABEL_EN,l.LABEL_FR,l.LABEL_PR,l.LABEL_SP, \n"
                + "c.`REALM_ID` as `REALM_ID`,'static.product.productName' as `LABEL_FOR` \n"
                + "FROM fasp.rm_product c \n"
                + "left join ap_label l on l.LABEL_ID=c.LABEL_ID\n"
                + "union \n"
                + "SELECT l.LABEL_ID,l.LABEL_EN,l.LABEL_FR,l.LABEL_PR,l.LABEL_SP, \n"
                + "c.`REALM_ID` as `REALM_ID`,'static.product.genericProductName' as `LABEL_FOR` \n"
                + "FROM fasp.rm_product c \n"
                ...
                + "union \n"
                + "SELECT l.LABEL_ID,l.LABEL_EN,l.LABEL_FR,l.LABEL_PR,l.LABEL_SP, \n"
                + "f.`REALM_ID` as `REALM_ID`,'static.subFundingSource.subFundingSourceName' as `LABEL_FOR` \n"
                + "FROM fasp.rm_sub_funding_source c \n"
                + "left join ap_label l on l.LABEL_ID=c.LABEL_ID\n"
                + "left join rm_funding_source f on f.FUNDING_SOURCE_ID=c.`FUNDING_SOURCE_ID`\n"
                + "union \n"
                + "SELECT l.LABEL_ID,l.LABEL_EN,l.LABEL_FR,l.LABEL_PR,l.LABEL_SP, \n"
                ...
                + "FROM fasp.us_role c \n"
                + "left join ap_label l on l.LABEL_ID=c.LABEL_ID\n"
                + ") label where label.REALM_ID=-1 OR (label.`REALM_ID`=? OR ?=-1) order by label.`LABEL_ID`,label.`LABEL_FOR`";
