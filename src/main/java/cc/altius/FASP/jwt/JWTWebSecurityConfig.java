...
public class JWTWebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers("/api/budget/**").access("hasAnyRole('ROLE_BF_EDIT_BUDGET')")
                //Country
                .antMatchers(HttpMethod.POST, "/api/country/**").access("hasAnyRole('ROLE_BF_ADD_COUNTRY')")
                .antMatchers("/api/country/**").access("hasAnyRole('ROLE_BF_EDIT_COUNTRY')")
                //Currency
                .antMatchers(HttpMethod.POST, "/api/currency/**").access("hasAnyRole('ROLE_BF_ADD_CURRENCY')")
                .antMatchers("/api/currency/**").access("hasAnyRole('ROLE_BF_EDIT_CURRENCY')")
                //Dashboard
                ...
                .antMatchers("/api/dataSource/**").access("hasAnyRole('ROLE_BF_EDIT_DATA_SOURCE')")
                //DataSourceType                
                .antMatchers(HttpMethod.POST, "/api/dataSourceType/**").access("hasAnyRole('ROLE_BF_ADD_DATA_SOURCE_TYPE')")
                .antMatchers("/api/dataSourceType/**").access("hasAnyRole('ROLE_BF_EDIT_DATA_SOURCE_TYPE')")
                //dimension    
                .antMatchers(HttpMethod.POST, "/api/dimension/**").access("hasAnyRole('ROLE_BF_ADD_DIMENSION')")
                .antMatchers("/api/dimension/**").access("hasAnyRole('ROLE_BF_EDIT_DIMENSION')")
                //Equivalency Unit                
                ...
                .antMatchers("/api/fundingSource/**").access("hasAnyRole('ROLE_BF_EDIT_FUNDING_SOURCE')")
                ...
                .antMatchers("/api/healthArea/**").access("hasAnyRole('ROLE_BF_EDIT_HEALTH_AREA')")
                ...
                .antMatchers("/api/integration/**").access("hasAnyRole('ROLE_BF_EDIT_INTEGRATION')")
                ...
                .antMatchers("/api/procurementUnit/**").access("hasAnyRole('ROLE_BF_EDIT_PROCUREMENT_UNIT')")
                ...
                .antMatchers("/api/planningUnit/capacity/**").access("hasAnyRole('ROLE_BF_MAP_PLANNING_UNIT_CAPACITY')")
                ...
                .antMatchers("/api/pipeline/inventory/**").access("hasAnyRole('ROLE_BF_PIPELINE_PROGRAM_IMPORT')")
                ...
                .antMatchers("/api/organisationType/**").access("hasAnyRole('ROLE_BF_EDIT_ORGANIZATION_TYPE')")
