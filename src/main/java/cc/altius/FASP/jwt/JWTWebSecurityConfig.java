    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/budget/").hasAnyAuthority("ROLE_BF_LIST_BUDGET")
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/ticket/openIssues").hasAnyAuthority("ROLE_BF_APPLICATION_DASHBOARD")
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/treeTemplate").hasAnyAuthority("ROLE_BF_LIST_TREE_TEMPLATE")
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/dataSource/all").hasAnyAuthority("ROLE_BF_LIST_DATA_SOURCE","ROLE_BF_PIPELINE_PROGRAM_IMPORT","ROLE_BF_SUPPLY_PLAN_VERSION_AND_REVIEW")
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/forecastMethod/all").hasAnyAuthority("ROLE_BF_LIST_FORECAST_METHOD")
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/forecastMethodType").hasAnyAuthority("ROLE_BF_LIST_FORECAST_METHOD")
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/healthArea/**").hasAnyAuthority("ROLE_BF_LIST_HEALTH_AREA","ROLE_BF_EDIT_HEALTH_AREA")
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/user/**").hasAnyAuthority("ROLE_BF_LIST_USER","ROLE_BF_EDIT_USER")
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/realmCountry/").hasAnyAuthority("ROLE_BF_LIST_REALM_COUNTRY")
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/realmCountry/realmId/**").hasAnyAuthority("ROLE_BF_ADD_HEALTH_AREA","ROLE_BF_EDIT_HEALTH_AREA","ROLE_BF_ADD_DATASET","ROLE_BF_CREATE_A_PROGRAM","ROLE_BF_SET_UP_PROGRAM","ROLE_BF_ADD_ORGANIZATION","ROLE_BF_EDIT_ORGANIZATION","ROLE_BF_LIST_DATASET","ROLE_BF_LIST_PROGRAM","ROLE_BF_MAP_REALM_COUNTRY")
                        .requestMatchers(HttpMethod.GET,"/api/realmCountry/program/realmId/**").hasAnyAuthority("ROLE_BF_LOAD_DELETE_DATASET","ROLE_BF_MANUAL_TAGGING","ROLE_BF_REGION","ROLE_BF_FORECAST_MATRIX_REPORT","ROLE_BF_CONSUMPTION_GLOBAL_VIEW_REPORT","ROLE_BF_SHIPMENT_OVERVIEW_REPORT","ROLE_BF_GLOBAL_DEMAND_REPORT","ROLE_BF_STOCK_STATUS_GLOBAL_VIEW_REPORT","ROLE_BF_STOCK_STATUS_OVER_TIME_REPORT","ROLE_BF_SUPPLY_PLAN_VERSION_AND_REVIEW","ROLE_BF_WAREHOUSE_CAPACITY_REPORT")
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/program/").hasAnyAuthority("ROLE_BF_ADD_PROCUREMENT_AGENT","ROLE_BF_EDIT_PROCUREMENT_AGENT","ROLE_BF_FORECAST_ERROR_OVER_TIME_REPORT","ROLE_BF_INVENTORY_TURNS_REPORT")
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/realmCountry/realmId/**").hasAnyAuthority("ROLE_BF_PIPELINE_PROGRAM_IMPORT","ROLE_BF_CREATE_A_PROGRAM")
                        .requestMatchers(HttpMethod.GET,"/api/organisation/realmId/**").hasAnyAuthority("ROLE_BF_PIPELINE_PROGRAM_IMPORT","ROLE_BF_CREATE_A_PROGRAM")
                        .requestMatchers(HttpMethod.GET,"/api/healthArea/realmId/**").hasAnyAuthority("ROLE_BF_PIPELINE_PROGRAM_IMPORT","ROLE_BF_CREATE_A_PROGRAM","ROLE_BF_EDIT_PROGRAM","ROLE_BF_ADD_DATASET","ROLE_BF_EDIT_DATASET")
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/procurementAgentType/**").hasAnyAuthority("ROLE_BF_ADD_PROCUREMENT_AGENT","ROLE_BF_EDIT_PROCUREMENT_AGENT","ROLE_BF_LIST_PROCUREMENT_AGENT","ROLE_BF_GLOBAL_DEMAND_REPORT")
                        .requestMatchers(HttpMethod.PUT,"/api/procurementAgentType/**").hasAnyAuthority("ROLE_BF_EDIT_PROCUREMENT_AGENT")
                        .requestMatchers(HttpMethod.GET,"/api/productCategory/realmId/**").hasAnyAuthority("ROLE_BF_ADD_FORECASTING_UNIT","ROLE_BF_LIST_FORECASTING_UNIT","ROLE_BF_MANUAL_TAGGING","ROLE_BF_LIST_PLANNING_UNIT","ROLE_BF_PRODUCT_CATALOG_REPORT","ROLE_BF_GLOBAL_DEMAND_REPORT","ROLE_BF_LIST_PRODUCT_CATEGORY","ROLE_BF_ADD_PROGRAM_PRODUCT","ROLE_BF_INVENTORY_TURNS_REPORT")
                        .requestMatchers(HttpMethod.POST,"/api/report/consumptionForecastVsActual/**").hasAnyAuthority("ROLE_BF_CONSUMPTION_REPORT")
                        .requestMatchers(HttpMethod.POST,"/api/report/stockStatusMatrix/**").hasAnyAuthority("ROLE_BF_STOCK_STATUS_MATRIX_REPORT")
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/planningUnit/all/**").hasAnyAuthority("ROLE_BF_LIST_PLANNING_UNIT_CAPACITY","ROLE_BF_MAP_PLANNING_UNIT","ROLE_BF_ADD_PROGRAM_PRODUCT","ROLE_BF_LIST_ALTERNATE_REPORTING_UNIT","ROLE_BF_PIPELINE_PROGRAM_IMPORT","ROLE_BF_ADD_PROCUREMENT_AGENT")
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/organisationType/all/**").hasAnyAuthority("ROLE_BF_LIST_ORGANIZATION_TYPE")
                        .requestMatchers(HttpMethod.GET,"/api/organisationType/realmId/**").hasAnyAuthority("ROLE_BF_ADD_ORGANIZATION_TYPE","ROLE_BF_EDIT_ORGANIZATION_TYPE")
                        ...
                        .requestMatchers("/api/getDatabaseLabelsListAll/").hasAnyAuthority("ROLE_BF_LABEL_TRANSLATIONS")
