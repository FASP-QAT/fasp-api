...
public class JWTWebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers(HttpMethod.GET, "/api/realm/**").access("hasRole('ROLE_BF_ADD_HEALTH_AREA','ROLE_BF_EDIT_HEALTH_AREA','ROLE_BF_ADD_ORGANIZATION','ROLE_BF_EDIT_ORGANIZATION','ROLE_BF_ADD_ORGANIZATION_TYPE','ROLE_BF_EDIT_ORGANIZATION_TYPE')")
                ...
                .antMatchers(HttpMethod.GET, "/api/role/**").access("hasRole('ROLE_BF_ADD_ROLE')")
                .antMatchers(HttpMethod.POST, "/api/role/**").access("hasRole('ROLE_BF_EDIT_ROLE')")
                .antMatchers(HttpMethod.PUT, "/api/user/**").access("hasRole('ROLE_BF_LIST_USER')")
                .antMatchers(HttpMethod.GET, "/api/user/**").access("hasRole('ROLE_BF_ADD_USER')")
                .antMatchers(HttpMethod.POST, "/api/user/**").access("hasRole('ROLE_BF_LIST_USER','ROLE_BF_EDIT_USER')")
                //UserManualService
                .antMatchers(HttpMethod.POST, "/api/userManual/uploadUserManual/**").access("hasRole('ROLE_BF_UPLOAD_USER_MANUAL')")
                //UsageTemplateService
                .antMatchers(HttpMethod.POST, "/api/usageTemplate/all/**").access("hasRole('ROLE_BF_LIST_USAGE_TEMPLATE')")
                .antMatchers(HttpMethod.GET, "/api/usageTemplate/**").access("hasRole('ROLE_BF_LIST_USAGE_TEMPLATE')")
                .antMatchers(HttpMethod.GET, "/api/usageTemplate/**").access("hasRole('ROLE_BF_LIST_USAGE_TEMPLATE')")
                .antMatchers(HttpMethod.POST, "/api/usageTemplate/tracerCategory/**").access("hasRole('ROLE_BF_EDIT_TREE_TEMPLATE','ROLE_BF_ADD_TREE_TEMPLATE','ROLE_BF_VIEW_TREE_TEMPLATES')")
                //UsagePeriodService
                ...
                .antMatchers(HttpMethod.GET, "/api/usagePeriod/**").access("hasRole('ROLE_BF_LIST_USAGE_PERIOD')")
                //UnitService
                .antMatchers(HttpMethod.POST, "/api/unit/**").access("hasRole('ROLE_BF_ADD_UNIT')")
                .antMatchers(HttpMethod.POST, "/api/unit/**").access("hasRole('ROLE_BF_EDIT_TREE_TEMPLATE','ROLE_BF_ADD_TREE_TEMPLATE','ROLE_BF_VIEW_TREE_TEMPLATES','ROLE_BF_LIST_USAGE_TEMPLATE','ROLE_BF_LIST_EQUIVALENCY_UNIT_MAPPING','ROLE_BF_ADD_FORECASTING_UNIT','ROLE_BF_ADD_PLANNING_UNIT',ROLE_BF_ADD_PROCUREMENT_UNIT',ROLE_BF_EDIT_PROCUREMENT_UNIT',ROLE_BF_MANAGE_REALM_COUNTRY_PLANNING_UNIT','ROLE_BF_LIST_UNIT')")
                .antMatchers(HttpMethod.GET, "/api/unit/**").access("hasRole('ROLE_BF_EDIT_UNIT')")
                .antMatchers(HttpMethod.PUT, "/api/unit/dimension/**").access("hasRole('ROLE_BF_EDIT_TREE_TEMPLATE','ROLE_BF_ADD_TREE_TEMPLATE','ROLE_BF_VIEW_TREE_TEMPLATES')")
                //TracerCategoryService
                .antMatchers(HttpMethod.POST, "/api/tracerCategory/**").access("hasRole('ROLE_BF_LIST_IMPORT_FROM_QAT_SUPPLY_PLAN','ROLE_BF_EDIT_TREE_TEMPLATE','ROLE_BF_ADD_TREE_TEMPLATE','ROLE_BF_VIEW_TREE_TEMPLATES','ROLE_BF_LIST_EQUIVALENCY_UNIT_MAPPING','ROLE_BF_ADD_FORECASTING_UNIT','ROLE_BF_LIST_FORECASTING_UNIT','ROLE_BF_LIST_PLANNING_UNIT_SETTING','ROLE_BF_LIST_TRACER_CATEGORY','ROLE_BF_LIST_USAGE_TEMPLATE','ROLE_BF_EDIT_TRACER_CATEGORY')")
                .antMatchers(HttpMethod.GET, "/api/tracerCategory/**").access("hasRole('ROLE_BF_ADD_TRACER_CATEGORY')")
                .antMatchers(HttpMethod.POST, "/api/tracerCategory/**").access("hasRole('ROLE_BF_EDIT_TRACER_CATEGORY')")
                .antMatchers(HttpMethod.PUT, "/api/tracerCategory/realmId/**").access("hasRole('ROLE_BF_LIST_PLANNING_UNIT','ROLE_BF_FORECAST_MATRIX_REPORT','ROLE_BF_PRODUCT_CATALOG_REPORT','ROLE_BF_STOCK_STATUS_GLOBAL_VIEW_REPORT','ROLE_BF_VIEW_STOCK_STATUS_MATRIX')")
                ...
                //SupplierService
                .antMatchers(HttpMethod.PUT, "/api/supplier/**").access("hasRole('ROLE_BF_ADD_SUPPLIER')")
                .antMatchers(HttpMethod.POST, "/api/supplier/**").access("hasRole('ROLE_BF_MAP_PLANNING_UNIT_CAPACITY','ROLE_BF_ADD_PROCUREMENT_UNIT','ROLE_BF_LIST_SUPPLIER','ROLE_BF_EDIT_SUPPLIER')")
                .antMatchers(HttpMethod.GET, "/api/supplier/**").access("hasRole('ROLE_BF_EDIT_SUPPLIER')")
                //subFundingSourceService

                //SignupService

                //ShipmentStatusService
                .antMatchers(HttpMethod.GET, "/api/getShipmentStatusListActive/**").access("hasRole('ROLE_BF_ANNUAL_SHIPMENT_COST_REPORT','ROLE_BF_SUPPLY_PLAN_VERSION_AND_REVIEW','ROLE_BF_SHIPMENT_OVERVIEW_REPORT')")
                .antMatchers(HttpMethod.GET, "/api/editShipmentStatus/**").access("hasRole(')")
                //ReportService
                .antMatchers(HttpMethod.PUT, "/api/report/forecastMetricsMonthly/**").access("hasRole('ROLE_BF_FORECAST_ERROR_OVER_TIME_REPORT')")
                ...
                .antMatchers(HttpMethod.POST, "/api/programVersion/programId/**").access("hasRole('ROLE_BF_SUPPLY_PLAN_VERSION_AND_REVIEW')")
                .antMatchers(HttpMethod.GET, "/api/report/costOfInventory/**").access("hasRole('ROLE_BF_COST_OF_INVENTORY_REPORT')")
                ...
                //RegistrationService
                .antMatchers(HttpMethod.POST, "/api/getCountryList/**").access("hasRole(')")
                .antMatchers(HttpMethod.GET, "/api/getStateList/**").access("hasRole(')")
                .antMatchers(HttpMethod.GET, "/api/getCityList/**").access("hasRole(')")
                .antMatchers(HttpMethod.GET, "/api/saveRegistration/**").access("hasRole(')")
                .antMatchers(HttpMethod.PUT, "/api/getUserApprovalList/**").access("hasRole(')")
                //RegionService
                .antMatchers(HttpMethod.PUT, "/api/region//**").access("hasRole('ROLE_BF_REGION')")
                .antMatchers(HttpMethod.PUT, "/api/region//**").access("hasRole('ROLE_BF_REGION')")
                ...
                //RealmService
                .antMatchers(HttpMethod.GET, "/api/realm/**").access("hasRole('ROLE_BF_CREATE_REALM')")
                .antMatchers(HttpMethod.POST, "/api/realm/**").fullyAuthenticated()
                .antMatchers(HttpMethod.GET, "/api/realm/**").access("hasRole('ROLE_BF_EDIT_REALM')")
                //RealmCountryService
                .antMatchers(HttpMethod.PUT, "/api/realmCountry/**").access("hasRole('ROLE_BF_LIST_REALM_COUNTRY')")
                .antMatchers(HttpMethod.POST, "/api/realmCountry/**").access("hasRole('ROLE_BF_LIST_REALM_COUNTRY','ROLE_BF_REGION','ROLE_BF_MAP_ACCESS_CONTROL','ROLE_BF_ADD_USER','ROLE_BF_EDIT_USER',ROLE_BF_LIST_USER','ROLE_BF_LIST_ALTERNATE_REPORTING_UNIT','ROLE_BF_MAP_REGION','ROLE_BF_MANAGE_REALM_COUNTRY_PLANNING_UNIT')")
                .antMatchers(HttpMethod.GET, "/api/realmCountry/**").access("hasRole(')")
                .antMatchers(HttpMethod.PUT, "/api/realmCountry/realmId/**").access("hasRole('ROLE_BF_ADD_HEALTH_AREA','ROLE_BF_EDIT_HEALTH_AREA','ROLE_BF_ADD_DATASET','ROLE_BF_CREATE_A_PROGRAM','ROLE_BF_SET_UP_PROGRAM','ROLE_BF_ADD_ORGANIZATION','ROLE_BF_EDIT_ORGANIZATION','ROLE_BF_LIST_DATASET','ROLE_BF_LIST_PROGRAM','ROLE_BF_MAP_REALM_COUNTRY')")
                .antMatchers(HttpMethod.GET, "//api/realmCountry/${realmCountryId}/planningUnit/**").access("hasRole(')")
                ...
                .antMatchers(HttpMethod.GET, "/api/realmCountry/${realmCountryId}/planningUnit/all/**").access("hasRole(')")
                .antMatchers(HttpMethod.GET, "/api/realmCountry/programIds/planningUnit/**").access("hasRole('ROLE_BF_MANUAL_TAGGING','ROLE_BF_LIST_ALTERNATE_REPORTING_UNIT','ROLE_BF_SUPPLY_PLAN_VERSION_AND_REVIEW')")
                .antMatchers(HttpMethod.PUT, "/api/realmCountry/program/realmId/**").access("hasRole('ROLE_BF_LOAD_DELETE_DATASET','ROLE_BF_MANUAL_TAGGING','ROLE_BF_REGION','ROLE_BF_FORECAST_MATRIX_REPORT','ROLE_BF_CONSUMPTION_GLOBAL_VIEW_REPORT','ROLE_BF_SHIPMENT_OVERVIEW_REPORT','ROLE_BF_GLOBAL_DEMAND_REPORT','ROLE_BF_STOCK_STATUS_GLOBAL_VIEW_REPORT','ROLE_BF_STOCK_STATUS_OVER_TIME_REPORT','ROLE_BF_SUPPLY_PLAN_VERSION_AND_REVIEW','ROLE_BF_WAREHOUSE_CAPACITY_REPORT')")
                .antMatchers(HttpMethod.GET, "/api/realmCountry/program/**").access("hasRole(')")
                //QuantimedImportService
                .antMatchers(HttpMethod.GET, "/api/quantimed/quantimedImport/**").access("hasRole('ROLE_BF_QUANTIMED_IMPORT')")
                //ProgramService
                .antMatchers(HttpMethod.POST, "/api/programData/programId/**").access("hasRole('ROLE_BF_COMMIT_VERSION','ROLE_BF_SUPPLY_PLAN_VERSION_AND_REVIEW')")
                .antMatchers(HttpMethod.GET, "/api/programData/**").access("hasRole('ROLE_BF_COMMIT_VERSION')")
                .antMatchers(HttpMethod.POST, "/api/program/**").fullyAuthenticated()
                .antMatchers(HttpMethod.GET, "/api/program/**").access("hasRole('ROLE_BF_ADD_PROGRAM_PRODUCT','ROLE_BF_CREATE_A_PROGRAM')")
                .antMatchers(HttpMethod.POST, "/api/program/**").access("hasRole('ROLE_BF_EDIT_PROGRAM')")
                .antMatchers(HttpMethod.PUT, "/api/dataset/**").access("hasRole('ROLE_BF_COMPARE_VERSION','ROLE_BF_LIST_DATASET','ROLE_BF_LIST_TREE','ROLE_BF_VERSION_SETTINGS','ROLE_BF_LIST_EQUIVALENCY_UNIT_MAPPING','ROLE_BF_CONSUMPTION_FORECAST_ERROR','ROLE_BF_LIST_MONTHLY_FORECAST','ROLE_BF_LIST_FORECAST_SUMMARY','ROLE_BF_VIEW_FORECAST_SUMMARY','ROLE_BF_LIST_USAGE_TEMPLATE','ROLE_BF_MODELING_VALIDATION','ROLE_BF_PRODUCT_VALIDATION')")
                ...
                .antMatchers(HttpMethod.GET, "/api/realmCountry/realmId/**").fullyAuthenticated()
                .antMatchers(HttpMethod.GET, "/api/organisation/realmId/**").access("hasRole('ROLE_BF_ADD_DATASET','ROLE_BF_EDIT_DATASET','ROLE_BF_CREATE_A_PROGRAM','ROLE_BF_EDIT_PROGRAM','ROLE_BF_SET_UP_PROGRAM')")
                .antMatchers(HttpMethod.GET, "/api/healthArea/realmId/**").access("hasRole('ROLE_BF_ADD_DATASET','ROLE_BF_EDIT_DATASET','ROLE_BF_CREATE_A_PROGRAM','ROLE_BF_EDIT_PROGRAM','ROLE_BF_SET_UP_PROGRAM')")
                ...
                .antMatchers(HttpMethod.PUT, "/api/user/realmId/**").access("hasRole('ROLE_BF_ADD_DATASET','ROLE_BF_EDIT_DATASET','ROLE_BF_CREATE_A_PROGRAM','ROLE_BF_EDIT_PROGRAM','ROLE_BF_SET_UP_PROGRAM')")
                .antMatchers(HttpMethod.GET, "/api/program/realmId/**").access("hasRole('ROLE_BF_PRODUCT_CATALOG_REPORT')")
                .antMatchers(HttpMethod.GET, "/api/programData/**").access("hasRole('ROLE_BF_COMMIT_VERSION')")
                .antMatchers(HttpMethod.PUT, "/api/program/initialize/**").access("hasRole('ROLE_BF_SET_UP_PROGRAM')")
                .antMatchers(HttpMethod.POST, "/api/versionStatus/**").access("hasRole('ROLE_BF_ADD_INTEGRATION_PROGRAM','ROLE_BF_SUPPLY_PLAN_VERSION_AND_REVIEW','ROLE_BF_SUPPLY_PLAN_VERSION_AND_REVIEW')")
                .antMatchers(HttpMethod.GET, "/api/programVersion/programId/**").access("hasRole('ROLE_BF_SUPPLY_PLAN_VERSION_AND_REVIEW')")
                .antMatchers(HttpMethod.PUT, "/api/versionType/**").access("hasRole('ROLE_BF_SUPPLY_PLAN_VERSION_AND_REVIEW','ROLE_BF_COMMIT_VERSION')")
                .antMatchers(HttpMethod.GET, "/api/programData/checkNewerVersions/**").access("hasRole('ROLE_BF_APPLICATION_DASHBOARD','ROLE_BF_IMPORT_DATASET','ROLE_BF_LOAD_DELETE_DATASET','ROLE_BF_DELETE_LOCAL_PROGRAM','ROLE_BF_IMPORT_PROGARM')")
                .antMatchers(HttpMethod.POST, "/api/healthArea/realmCountryId/**").access("hasRole('ROLE_BF_ADD_DATASET','ROLE_BF_EDIT_DATASET','ROLE_BF_EDIT_PROGRAM')")
                .antMatchers(HttpMethod.GET, "/api/organisation/realmCountryId/**").access("hasRole('ROLE_BF_ADD_DATASET','ROLE_BF_EDIT_DATASET','ROLE_BF_EDIT_PROGRAM')")
                .antMatchers(HttpMethod.GET, "/api/problemStatus/**").access("hasRole('ROLE_BF_SUPPLY_PLAN_VERSION_AND_REVIEW')")
                .antMatchers(HttpMethod.GET, "/api/programData/getLatestVersionForProgram/**").access("hasRole('ROLE_BF_SUPPLY_PLAN_VERSION_AND_REVIE')")
                .antMatchers(HttpMethod.POST, "/api/programData/getLastModifiedDateForProgram/**").access("hasRole('ROLE_BF_COMMIT_VERSION')")
                .antMatchers(HttpMethod.GET, "/api/dataset/**").access("hasRole('ROLE_BF_ADD_DATASET)")
                .antMatchers(HttpMethod.POST, "/api/dataset/**").access("hasRole('ROLE_BF_EDIT_DATASET')")
                .antMatchers(HttpMethod.PUT, "/api/dataset/**").access("hasRole('ROLE_BF_EDIT_DATASET')")
                .antMatchers(HttpMethod.POST, "/api/programData/checkIfCommitRequestExistsForProgram//**").access("hasRole('ROLE_BF_COMMIT_VERSION')")
                .antMatchers(HttpMethod.POST, "/api/sendNotification/**").access("hasRole('ROLE_BF_COMMIT_VERSION','ROLE_BF_COMMIT_DATASET')")
                .antMatchers(HttpMethod.GET, "/api/erpLinking/otherProgramCheck/**").access("hasRole('ROLE_BF_COMMIT_VERSION')")
                .antMatchers(HttpMethod.POST, "/api/user/programId/**").access("hasRole('ROLE_BF_EDIT_DATASET','ROLE_BF_EDIT_PROGRAM')")
                .antMatchers(HttpMethod.GET, "/api/problemReport/createManualProblem/**").access("hasRole('ROLE_BF_SUPPLY_PLAN_VERSION_AND_REVIEW')")
                .antMatchers(HttpMethod.POST, "/api/dataset/versions/**").access("hasRole('ROLE_BF_VERSION_SETTINGS')")
                .antMatchers(HttpMethod.POST, "/api/programForDropDown/programType/**").access("hasRole('ROLE_BF_ADD_PROGRAM_PRODUCT')")
                //ProductService
                .antMatchers(HttpMethod.GET, "/api/report/consumptionForecastVsActual/**").access("hasRole('ROLE_BF_CONSUMPTION_REPORT')")
                ...
                .antMatchers(HttpMethod.POST, "/api/procurementUnit/all/**").access("hasRole('ROLE_BF_MAP_PROCUREMENT_UNIT','ROLE_BF_LIST_PROCUREMENT_UNIT')")
                .antMatchers(HttpMethod.GET, "/api/procurementUnit/**").access("hasRole('ROLE_BF_EDIT_PROCUREMENT_UNIT')")
                .antMatchers(HttpMethod.GET, "/api/procurementUnit/**").access("hasRole('ROLE_BF_ADD_PROCUREMENT_UNIT')")
                .antMatchers(HttpMethod.POST, "/api/procurementUnit/**").access("hasRole('ROLE_BF_EDIT_PROCUREMENT_UNIT')")
                .antMatchers(HttpMethod.PUT, "/api/procurementUnit/realmId/**").access("hasRole(')")
                //ProcurementAgentService
                .antMatchers(HttpMethod.GET, "/api/procurementAgent/**").access("hasRole('ROLE_BF_LIST_REALM_COUNTRY')")
                .antMatchers(HttpMethod.POST, "/api/procurementAgent/**").fullyAuthenticated()
                .antMatchers(HttpMethod.GET, "/api/procurementAgent/**").access("hasRole('ROLE_BF_EDIT_PROCUREMENT_AGENT','ROLE_BF_EDIT_PROCUREMENT_AGENT')")
                .antMatchers(HttpMethod.PUT, "/api/program/planningUnit/procurementAgent/**").access("hasRole('ROLE_BF_MAP_COUNTRY_SPECIFIC_PRICES')")
                .antMatchers(HttpMethod.GET, "/api/procurementAgent/planningUnit/**").access("hasRole('ROLE_BF_MAP_PLANNING_UNIT')")
                ...
                .antMatchers(HttpMethod.PUT, "/api/procurementAgentType/**").access("hasRole('ROLE_BF_ADD_PROCUREMENT_AGENT')")
                .antMatchers(HttpMethod.POST, "/api/procurementAgentType/**").access("hasRole('ROLE_BF_ADD_PROCUREMENT_AGENT','ROLE_BF_EDIT_PROCUREMENT_AGENT','ROLE_BF_LIST_PROCUREMENT_AGENT','ROLE_BF_GLOBAL_DEMAND_REPORT')")
                .antMatchers(HttpMethod.GET, "/api/procurementAgentType/**").access("hasRole('ROLE_BF_EDIT_PROCUREMENT_AGENT')")
                //ProductCategoryService
                .antMatchers(HttpMethod.GET, "/api/productCategory/**").access("hasRole('ROLE_BF_LIST_PRODUCT_CATEGORY)")
                //PlanningUnitService
                .antMatchers(HttpMethod.PUT, "/api/planningUnit/**").access("hasRole('ROLE_BF_ADD_PLANNING_UNIT')")
                .antMatchers(HttpMethod.POST, "/api/planningUnit/**").fullyAuthenticated()
                .antMatchers(HttpMethod.GET, "/api/planningUnit/**").access("hasRole('ROLE_BF_EDIT_PLANNING_UNIT','ROLE_BF_MAP_PLANNING_UNIT_CAPACITY')")
                .antMatchers(HttpMethod.PUT, "/api/planningUnit/all/**").access("hasRole('ROLE_BF_LIST_PLANNING_UNIT_CAPACITY','ROLE_BF_MAP_PLANNING_UNIT','ROLE_BF_ADD_PROGRAM_PRODUCT','ROLE_BF_LIST_ALTERNATE_REPORTING_UNIT','ROLE_BF_PIPELINE_PROGRAM_IMPORT')")
                ...
                .antMatchers(HttpMethod.GET, "/api/planningUnit/capacity/**").access("hasRole('ROLE_BF_MAP_PLANNING_UNIT_CAPACITY')")
                .antMatchers(HttpMethod.GET, "/api/planningUnit/programs/**").access("hasRole('ROLE_BF_LIST_ALTERNATE_REPORTING_UNIT,'ROLE_BF_FORECAST_MATRIX_REPORT','ROLE_BF_CONSUMPTION_GLOBAL_VIEW_REPORT','ROLE_BF_SHIPMENT_OVERVIEW_REPORT')")
                ...
                .antMatchers(HttpMethod.GET, "/api/planningUnit/productCategoryList/active/**").access("hasRole('ROLE_BF_MANUAL_TAGGING')")
                .antMatchers(HttpMethod.POST, "/api/planningUnit/realmCountry/**").access("hasRole('ROLE_BF_MANUAL_TAGGING')")
                ...
                .antMatchers(HttpMethod.GET, "/api/planningUnit/tracerCategory/program/**").access("hasRole('ROLE_BF_FORECAST_MATRIX_REPORT')")
                .antMatchers(HttpMethod.POST, "/api/procurementAgent/planningUnits/**").access("hasRole('ROLE_BF_LIST_PLANNING_UNIT_SETTING')")

                .antMatchers(HttpMethod.POST, "/api/planningUnit/programId/**").access("hasRole('ROLE_BF_LIST_MONTHLY_FORECAST','ROLE_BF_LIST_IMPORT_FROM_QAT_SUPPLY_PLAN','ROLE_BF_SUPPLY_PLAN_IMPORT')")
                ...
                //PlanningUnitCapacityService
                .antMatchers(HttpMethod.GET, "/api/planningUnit/capacity/all/**").access("hasRole('ROLE_BF_LIST_PLANNING_UNIT_CAPACITY')")
                //PipelineService
                .antMatchers(HttpMethod.GET, "/api/pipelineJson/**").access("hasRole('ROLE_BF_PIPELINE_PROGRAM_IMPORT')")
                .antMatchers(HttpMethod.POST, "/api/pipeline/**").access("hasRole('ROLE_BF_PIPELINE_PROGRAM_IMPORT')")
                ...
                .antMatchers(HttpMethod.GET, "/api/pipeline/planningUnit/**").access("hasRole('ROLE_BF_PIPELINE_PROGRAM_IMPORT')")
                .antMatchers(HttpMethod.PUT, "/api/qatTemp/planningUnitList/**").access("hasRole('ROLE_BF_PIPELINE_PROGRAM_IMPORT')")
                ...
                .antMatchers(HttpMethod.GET, "/api/pipeline/consumption/**").access("hasRole('ROLE_BF_PIPELINE_PROGRAM_IMPORT')")
                .antMatchers(HttpMethod.PUT, "/api/qatTemp/consumption/**").access("hasRole('ROLE_BF_PIPELINE_PROGRAM_IMPORT')")
                .antMatchers(HttpMethod.GET, "/api/pipeline/shipment/**").access("hasRole('ROLE_BF_PIPELINE_PROGRAM_IMPORT')")
                .antMatchers(HttpMethod.POST, "/api/pipeline/inventory/**").access("hasRole('ROLE_BF_PIPELINE_PROGRAM_IMPORT')")
                .antMatchers(HttpMethod.GET, "/api/pipeline/inventory/**").access("hasRole('ROLE_BF_PIPELINE_PROGRAM_IMPORT')")
                .antMatchers(HttpMethod.PUT, "/api/qatTemp/planningUnitListFinalInventry/**").access("hasRole('ROLE_BF_PIPELINE_PROGRAM_IMPORT')")
                .antMatchers(HttpMethod.GET, "/api/pipeline/programdata/**").access("hasRole('ROLE_BF_PIPELINE_PROGRAM_IMPORT')")
                .antMatchers(HttpMethod.POST, "/api/qatTemp/datasource/**").access("hasRole('ROLE_BF_PIPELINE_PROGRAM_IMPORT')")
                .antMatchers(HttpMethod.GET, "/api/pipeline/datasource/**").access("hasRole('ROLE_BF_PIPELINE_PROGRAM_IMPORT')")
                .antMatchers(HttpMethod.PUT, "/api/qatTemp/fundingsource/**").access("hasRole('ROLE_BF_PIPELINE_PROGRAM_IMPORT')")
                .antMatchers(HttpMethod.GET, "/api/pipeline/fundingsource/**").access("hasRole('ROLE_BF_PIPELINE_PROGRAM_IMPORT')")
                .antMatchers(HttpMethod.PUT, "/api/qatTemp/procurementagent/**").access("hasRole('ROLE_BF_PIPELINE_PROGRAM_IMPORT')")
                .antMatchers(HttpMethod.GET, "/api/pipeline/procurementagent/**").access("hasRole('ROLE_BF_PIPELINE_PROGRAM_IMPORT')")
                ...
                .antMatchers(HttpMethod.PUT, "/api/organisationType/**").access("hasRole('ROLE_BF_ADD_ORGANIZATION_TYPE')")
                .antMatchers(HttpMethod.POST, "/api/organisationType/**").access("hasRole('ROLE_BF_EDIT_ORGANIZATION_TYPE')")
                .antMatchers(HttpMethod.GET, "/api/organisationType/**").access("hasRole('ROLE_BF_EDIT_ORGANIZATION_TYPE')")
                .antMatchers(HttpMethod.PUT, "/api/organisationType/all/**").access("hasRole('ROLE_BF_LIST_ORGANIZATION_TYPE')")
                ...
                //OrganisationService
                .antMatchers(HttpMethod.GET, "/api/organisation/**").access("hasRole('ROLE_BF_ADD_ORGANIZATION')")
                .antMatchers(HttpMethod.POST, "/api/organisation/**").fullyAuthenticated()
                .antMatchers(HttpMethod.GET, "/api/organisation/**").access("hasRole('ROLE_BF_EDIT_ORGANIZATION')")
                .antMatchers(HttpMethod.PUT, "/api/realmCountry/realmId/**").access("hasRole('ROLE_BF_ADD_ORGANIZATION','ROLE_BF_EDIT_ORGANIZATION')")
                ...
                .antMatchers(HttpMethod.GET, "/api/modelingType/**").access("hasRole('ROLE_BF_LIST_MODELING_TYPE')")
                .antMatchers(HttpMethod.POST, "/api/modelingType/all/**").access("hasRole('ROLE_BF_EDIT_TREE_TEMPLATE','ROLE_BF_ADD_TREE_TEMPLATE','ROLE_BF_VIEW_TREE_TEMPLATES','ROLE_BF_LIST_MODELING_TYPE')")
                //MasterSyncService
                ...
                .antMatchers(HttpMethod.POST, "/api/erpLinking/shipmentLinkingNotification/programId/**").access("hasRole('ROLE_BF_MANUAL_TAGGING')")
                .antMatchers(HttpMethod.GET, "/api/erpLinking/updateNotification/**").access("hasRole('ROLE_BF_MANUAL_TAGGING')")
                .antMatchers(HttpMethod.PUT, "/api/manualTagging/notLinkedShipments/**").access("hasRole(')")
                ...
                .antMatchers(HttpMethod.POST, "/api/shipmentListForDelinking/**").access("hasRole('ROLE_BF_DELINKING')")
                .antMatchers(HttpMethod.POST, "/api/erpLinking/getNotificationSummary/**").access("hasRole('ROLE_BF_MANUAL_TAGGING')")
                .antMatchers(HttpMethod.GET, "/api/erpLinking/notLinkedQatShipments/programId/**").access("hasRole('ROLE_BF_MANUAL_TAGGING')")
                .antMatchers(HttpMethod.POST, "/api/erpLinking/autoCompleteOrder/**").access("hasRole('ROLE_BF_MANUAL_TAGGING')")
                .antMatchers(HttpMethod.GET, "/api/erpLinking/autoCompletePu/**").access("hasRole('ROLE_BF_MANUAL_TAGGING')")
                ...
                //LanguageService
                .antMatchers(HttpMethod.GET, "/api/language/**").access("hasRole('ROLE_BF_ADD_LANGUAGE')")
                .antMatchers(HttpMethod.POST, "/api/language/**").access("hasRole('ROLE_BF_ADD_COUNTRY','ROLE_BF_EDIT_COUNTRY','ROLE_BF_LABEL_TRANSLATIONS','ROLE_BF_ADD_USER','ROLE_BF_EDIT_USER','ROLE_BF_LIST_USER','ROLE_BF_EDIT_LANGUAGE')")
