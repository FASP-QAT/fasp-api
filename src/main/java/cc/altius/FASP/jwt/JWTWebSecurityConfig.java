    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/realmCountry/realmId/**").hasAnyAuthority("ROLE_BF_TICKETING","ROLE_BF_ADD_HEALTH_AREA","ROLE_BF_EDIT_HEALTH_AREA","ROLE_BF_ADD_DATASET","ROLE_BF_CREATE_A_PROGRAM","ROLE_BF_SET_UP_PROGRAM","ROLE_BF_ADD_ORGANIZATION","ROLE_BF_EDIT_ORGANIZATION","ROLE_BF_LIST_DATASET","ROLE_BF_LIST_PROGRAM","ROLE_BF_MAP_REALM_COUNTRY")
