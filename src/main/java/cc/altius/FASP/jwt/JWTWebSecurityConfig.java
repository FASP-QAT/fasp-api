    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth
                        ...
                        .requestMatchers("/exportProgramData/**","/exportManualJson").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST,"/api/datasetData").hasAnyAuthority("ROLE_BF_MASTER_DATA_SYNC", "ROLE_BF_COMMIT_DATASET", "ROLE_BF_LIST_TREE", "ROLE_BF_LOAD_DELETE_DATASET", "ROLE_BF_MODELING_VALIDATION", "ROLE_BF_PRODUCT_VALIDATION")
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/region").hasAnyAuthority("ROLE_BF_TICKETING")
                        .requestMatchers(HttpMethod.GET,"/api/region/**").hasAnyAuthority("ROLE_BF_TICKETING")
