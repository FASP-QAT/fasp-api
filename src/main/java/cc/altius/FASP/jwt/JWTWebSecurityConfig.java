    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/dropdown/forecastingUnit").hasAnyAuthority("ROLE_BF_TICKETING","ROLE_BF_ADD_PLANNING_UNIT")
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/report/updateProgramInfo/programTypeId/**").hasAnyAuthority("ROLE_BF_LIST_DATASET","ROLE_BF_LIST_ALTERNATE_REPORTING_UNIT")
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/dropdown/program/realm/**").hasAnyAuthority("ROLE_BF_ADD_BUDGET","ROLE_BF_EDIT_BUDGET","ROLE_BF_LIST_BUDGET","ROLE_BF_LIST_TREE","ROLE_BF_VERSION_SETTINGS","ROLE_BF_ADD_DATA_SOURCE","ROLE_BF_LIST_DATA_SOURCE","ROLE_BF_LIST_MONTHLY_FORECAST","ROLE_BF_LIST_FORECAST_SUMMARY","ROLE_BF_VIEW_FORECAST_SUMMARY","ROLE_BF_MANUAL_TAGGING","ROLE_BF_ADD_PROGRAM_PRODUCT","ROLE_BF_ANNUAL_SHIPMENT_COST_REPORT","ROLE_BF_BUDGET_REPORT","ROLE_BF_COST_OF_INVENTORY_REPORT","ROLE_BF_EXPIRIES_REPORT","ROLE_BF_SHIPMENT_COST_DETAILS_REPORT","ROLE_BF_PRODUCT_CATALOG_REPORT","ROLE_BF_SHIPMENT_DETAILS_REPORT","ROLE_BF_STOCK_ADJUSTMENT_REPORT","ROLE_BF_SUPPLY_PLAN_REPORT","ROLE_BF_STOCK_STATUS_REPORT","ROLE_BF_VIEW_STOCK_STATUS_MATRIX","ROLE_BF_STOCK_STATUS_OVER_TIME_REPORT","ROLE_BF_PROCUREMENT_AGENT_REPORT","ROLE_BF_FORECAST_ERROR_OVER_TIME_REPORT","ROLE_BF_CONSUMPTION_REPORT","ROLE_BF_ADD_USER","ROLE_BF_EDIT_USER","ROLE_BF_LIST_IMPORT_FROM_QAT_SUPPLY_PLAN")
                        .requestMatchers(HttpMethod.POST,"/api/dropdown/program/programType/**").hasAnyAuthority("ROLE_BF_MANUAL_INTEGRATION","ROLE_BF_FORECAST_MATRIX_REPORT","ROLE_BF_CONSUMPTION_GLOBAL_VIEW_REPORT","ROLE_BF_SHIPMENT_OVERVIEW_REPORT","ROLE_BF_GLOBAL_DEMAND_REPORT","ROLE_BF_STOCK_STATUS_GLOBAL_VIEW_REPORT","ROLE_BF_SUPPLY_PLAN_VERSION_AND_REVIEW","ROLE_BF_WAREHOUSE_CAPACITY_REPORT")
                        .requestMatchers(HttpMethod.GET,"/api/dropdown/planningUnit").hasAnyAuthority("ROLE_BF_LIST_PLANNING_UNIT_CAPACITY","ROLE_BF_ADD_PROCUREMENT_UNIT","ROLE_BF_LIST_PROCUREMENT_UNIT")
                        .requestMatchers(HttpMethod.GET,"/api/dropdown/realmCountry/realm/**").hasAnyAuthority("ROLE_BF_ADD_DATASET","ROLE_BF_LIST_DATASET","ROLE_BF_ADD_HEALTH_AREA","ROLE_BF_EDIT_HEALTH_AREA","ROLE_BF_ADD_ORGANIZATION","ROLE_BF_EDIT_ORGANIZATION","ROLE_BF_LIST_PROGRAM","ROLE_BF_REGION","ROLE_BF_FORECAST_MATRIX_REPORT","ROLE_BF_CONSUMPTION_GLOBAL_VIEW_REPORT","ROLE_BF_INVENTORY_TURNS_REPORT","ROLE_BF_SHIPMENT_OVERVIEW_REPORT","ROLE_BF_GLOBAL_DEMAND_REPORT","ROLE_BF_STOCK_STATUS_GLOBAL_VIEW_REPORT","ROLE_BF_SUPPLY_PLAN_VERSION_AND_REVIEW","ROLE_BF_WAREHOUSE_CAPACITY_REPORT","ROLE_BF_ADD_USER","ROLE_BF_EDIT_USER","ROLE_BF_SET_UP_PROGRAM")
                        .requestMatchers(HttpMethod.GET,"/api/dropdown/healthArea/realm/**").hasAnyAuthority("ROLE_BF_LIST_EQUIVALENCY_UNIT_MAPPING","ROLE_BF_ADD_TRACER_CATEGORY","ROLE_BF_EDIT_TRACER_CATEGORY","ROLE_BF_ADD_USER","ROLE_BF_EDIT_USER","ROLE_BF_SET_UP_PROGRAM")
                        .requestMatchers(HttpMethod.GET,"/api/dropdown/organisation/realm/**").hasAnyAuthority("ROLE_BF_TICKETING","ROLE_BF_ADD_USER","ROLE_BF_EDIT_USER")
                        .requestMatchers(HttpMethod.GET,"/api/dropdown/tracerCategory").hasAnyAuthority("ROLE_BF_EDIT_TREE_TEMPLATE","ROLE_BF_ADD_TREE_TEMPLATE","ROLE_BF_VIEW_TREE_TEMPLATES","ROLE_BF_ADD_FORECASTING_UNIT","ROLE_BF_LIST_FORECASTING_UNIT","ROLE_BF_LIST_IMPORT_FROM_QAT_SUPPLY_PLAN")
                        .requestMatchers(HttpMethod.POST,"/api/dropdown/tracerCategory/filter/multiplePrograms").hasAnyAuthority("ROLE_BF_PRODUCT_CATALOG_REPORT","ROLE_BF_STOCK_STATUS_GLOBAL_VIEW_REPORT","ROLE_BF_STOCK_STATUS_REPORT","ROLE_BF_VIEW_STOCK_STATUS_MATRIX")
                        .requestMatchers(HttpMethod.GET,"/api/dropdown/fundingSource").hasAnyAuthority("ROLE_BF_ANNUAL_SHIPMENT_COST_REPORT","ROLE_BF_BUDGET_REPORT","ROLE_BF_SHIPMENT_DETAILS_REPORT")
                        .requestMatchers(HttpMethod.POST,"/api/dropdown/procurementAgent/filter/multiplePrograms").hasAnyAuthority("ROLE_BF_ANNUAL_SHIPMENT_COST_REPORT","ROLE_BF_SHIPMENT_COST_DETAILS_REPORT","ROLE_BF_GLOBAL_DEMAND_REPORT","ROLE_BF_PROCUREMENT_AGENT_REPORT")
                        .requestMatchers(HttpMethod.POST,"/api/dropdown/planningUnit/program/filter/multipleProgramAndTracerCategory").hasAnyAuthority("ROLE_BF_MANUAL_TAGGING","ROLE_BF_ANNUAL_SHIPMENT_COST_REPORT","ROLE_BF_CONSUMPTION_REPORT","ROLE_BF_FORECAST_MATRIX_REPORT","ROLE_BF_FORECAST_ERROR_OVER_TIME_REPORT","ROLE_BF_CONSUMPTION_GLOBAL_VIEW_REPORT","ROLE_BF_SHIPMENT_COST_DETAILS_REPORT","ROLE_BF_SHIPMENT_OVERVIEW_REPORT","ROLE_BF_SHIPMENT_DETAILS_REPORT","ROLE_BF_STOCK_ADJUSTMENT_REPORT","ROLE_BF_VIEW_STOCK_STATUS_MATRIX","ROLE_BF_STOCK_STATUS_OVER_TIME_REPORT","ROLE_BF_PROCUREMENT_AGENT_REPORT")
                        .requestMatchers(HttpMethod.POST,"/api/dropdown/budget/filter/multipleFundingSources").hasAnyAuthority("ROLE_BF_SHIPMENT_DETAILS_REPORT")
                        .requestMatchers(HttpMethod.GET,"/api/dropdown/version/filter/programTypeId/**").hasAnyAuthority("ROLE_BF_LIST_TREE","ROLE_BF_LIST_MONTHLY_FORECAST","ROLE_BF_LIST_FORECAST_SUMMARY","ROLE_BF_VIEW_FORECAST_SUMMARY","ROLE_BF_MANUAL_INTEGRATION","ROLE_BF_ANNUAL_SHIPMENT_COST_REPORT","ROLE_BF_CONSUMPTION_REPORT","ROLE_BF_COST_OF_INVENTORY_REPORT","ROLE_BF_EXPIRIES_REPORT","ROLE_BF_FORECAST_ERROR_OVER_TIME_REPORT","ROLE_BF_SHIPMENT_COST_DETAILS_REPORT","ROLE_BF_SHIPMENT_DETAILS_REPORT","ROLE_BF_STOCK_ADJUSTMENT_REPORT","ROLE_BF_SUPPLY_PLAN_REPORT","ROLE_BF_STOCK_STATUS_REPORT","ROLE_BF_VIEW_STOCK_STATUS_MATRIX","ROLE_BF_STOCK_STATUS_OVER_TIME_REPORT","ROLE_BF_LIST_IMPORT_FROM_QAT_SUPPLY_PLAN")
                        .requestMatchers(HttpMethod.GET,"/api/dropdown/budget/program/**").hasAnyAuthority("ROLE_BF_SUPPLY_PLAN_VERSION_AND_REVIEW","ROLE_BF_SHIPMENT_DETAILS_REPORT")
                        .requestMatchers(HttpMethod.GET,"/api/report/updateProgramInfo/programTypeId/**").hasAnyAuthority("ROLE_BF_LIST_PROGRAM","ROLE_BF_LIST_ALTERNATE_REPORTING_UNIT")
