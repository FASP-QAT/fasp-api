 ...
 * @author akil
 */
public class ForecastingUnitWithSkuRowMapper implements RowMapper<ForecastingUnitWithSku> {

    @Override
    public ForecastingUnitWithSku mapRow(ResultSet rs, int rowNum) throws SQLException {
        ForecastingUnitWithSku p = new ForecastingUnitWithSku(
