...
//        Label l1 = new Label();
//        l1.setLabel_en(rs.getString("RL_ENG_LABEL"));
//        l1.setLabel_fr(rs.getString("RL_FR_LABEL"));
//        l1.setLabel_pr(rs.getString("RL_PR_LABEL"));
//        l1.setLabel_sp(rs.getString("RL_SP_LABEL"));
//        r.setLabel(l1);
...
//        lb.setLabel_en(rs.getString("LABEL_EN"));
//        lb.setLabel_fr(rs.getString("LABEL_FR"));
//        lb.setLabel_sp(rs.getString("LABEL_SP"));
//        lb.setLabel_pr(rs.getString("LABEL_PR"));
//        role.setLabel(lb);
//        u.setRole(role);
