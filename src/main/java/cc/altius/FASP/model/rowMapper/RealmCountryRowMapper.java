...
public class RealmCountryRowMapper implements RowMapper<RealmCountry> {
    ...
    public RealmCountry mapRow(ResultSet rs, int i) throws SQLException {
        ...
        rc.setShippedToArrivedAirLeadTime(rs.getDouble("SHIPPED_TO_ARRIVED_AIR_LEAD_TIME"));
        rc.setShippedToArrivedSeaLeadTime(rs.getDouble("SHIPPED_TO_ARRIVED_SEA_LEAD_TIME"));
