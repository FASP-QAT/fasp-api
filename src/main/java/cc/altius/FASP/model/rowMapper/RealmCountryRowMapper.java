...
public class RealmCountryRowMapper implements RowMapper<RealmCountry> {
    ...
    public RealmCountry mapRow(ResultSet rs, int i) throws SQLException {
        ...
        rc.setShippedToDeliveredBySeaLeadTime(rs.getDouble("SHIPPED_TO_DELIVERED_BY_SEA_LEAD_TIME"));
        rc.setShippedToDeliveredByAirLeadTime(rs.getDouble("SHIPPED_TO_DELIVERED_BY_AIR_LEAD_TIME"));
