    ...
    public List<SimplifiedSupplyPlan> extractData(ResultSet rs) throws SQLException, DataAccessException {
        ...
        while (rs.next()) {
            ...
            if (idx == -1) {
                ...
                sp.setOpeningBalanceWtbdps(rs.getDouble("OPENING_BALANCE_WTBDPS"));
                ...
                sp.setPlannedShipmentsTotalWtbdData(rs.getDouble("MANUAL_PLANNED_SHIPMENT_WTBD_QTY"));
                ...
                sp.setPlannedErpShipmentsTotalWtbdData(rs.getDouble("ERP_PLANNED_SHIPMENT_WTBD_QTY"));
                ...
                sp.setNationalAdjustmentWtbdps(rs.getDouble("NATIONAL_ADJUSTMENT_WTBDPS"));
                ...
                sp.setMosWtbdps(rs.getDouble("MOS_WTBDPS"));
                if (rs.wasNull()) {
                    sp.setMosWtbdps(null);
                }
            ...
            if (!rs.wasNull()) {
                ...
                sb.setUnallocatedQtyWtbdps(rs.getDouble("BATCH_CALCULATED_CONSUMPTION_QTY_WTBDPS"));
                if (rs.wasNull()) {
                    sb.setUnallocatedQtyWtbdps(null);
                }
