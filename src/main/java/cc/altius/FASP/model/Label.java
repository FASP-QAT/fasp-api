...
public class Label extends BaseModel {
    ...
    @JsonView({Views.InternalView.class, Views.DropDownView.class, Views.DropDown2View.class})
    ...
    @JsonView({Views.InternalView.class, Views.ReportView.class, Views.DropDownView.class, Views.DropDown2View.class})
