...
public class Shipment implements Serializable {
    ...
    @JsonView({Views.InternalView.class})
    private Boolean autoGeneratedFreight;
    @JsonView({Views.ArtmisView.class, Views.GfpVanView.class, Views.InternalView.class})
    ...
    public Boolean isAutoGeneratedFreight() {
        return autoGeneratedFreight;
    }

    public void setAutoGeneratedFreight(Boolean autoGeneratedFreight) {
        this.autoGeneratedFreight = autoGeneratedFreight;
    }
