...
public class IntegrationRestController {
    ...
    @Operation(description = "API used to get the Integration for a specific IntegrationId", summary = "Get Integration for a IntegrationId", tags = ("integration"))
    @Parameters(
    ...
    public ResponseEntity getIntegration(@PathVariable("integrationId") int integrationId, Authentication auth) {
        try {
            ...
            logger.error("Error while trying to get Funding source Id=" + integrationId, ae);
            return new ResponseEntity(new ResponseCode("static.message.listFailed"), HttpStatus.NOT_FOUND);
        } catch (AccessDeniedException ae) {
            logger.error("Error while trying to get Funding source Id=" + integrationId, ae);
            return new ResponseEntity(new ResponseCode("static.message.listFailed"), HttpStatus.FORBIDDEN);
        } catch (Exception e) {
            logger.error("Error while trying to get Funding source Id=" + integrationId, e);
            return new ResponseEntity(new ResponseCode("static.message.listFailed"), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }

    /**
     * API used to add a Integration
     *
     ...
     */
    @PostMapping(value = "")
    @Operation(description = "API used to add a Integration", summary = "Add Integration", tags = ("integration"))
    @Parameters(
    ...
    /**
     * API used to update a Integration
     *
     ...
     */
    @PutMapping(path = "")
    @Operation(description = "API used to update a Integration", summary = "Update Integration", tags = ("integration"))
    @Parameters(
