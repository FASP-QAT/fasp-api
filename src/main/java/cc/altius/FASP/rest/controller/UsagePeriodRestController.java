...
public class UsagePeriodRestController {
    ...
    /**
     * API used to get the complete UsageType list.
     *
     * @param auth
    ...
    @Parameters(
            @Parameter(name = "usagePeriod", description = "The list of UsagePeriod objects that you want to add or update. If usagePeriodId is null then it is added if usagePeriodId is not null it is updated"))
