...
public class PipelineDbRestController {
    ...
    @GetMapping("/qatTem/regions/{pipelineId}")
    ...
    @PutMapping("/pipeline/deletePipelineProgramData/{programName}")
    public ResponseEntity deletePipelineProgramData(@PathVariable("programName") String programName) {
        try {
            this.pipelineDbService.deletePipelineProgramData(programName);
            return new ResponseEntity(HttpStatus.OK);
        } catch (Exception e) {
            logger.error("Error while trying to delete Program data", e);
            return new ResponseEntity(new ResponseCode("static.program.errortext"),HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
