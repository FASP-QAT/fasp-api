...
public class ProgramDataRestController {
    ...
    @Operation(
        ...
        description = "Retrieve program data for a specific program and version"
    )
    ...
    @Operation(
        summary = "Get Load Program Data",
        description = "Retrieve program data for a list of programs and versions"
    )
...
//    }
    ...
    @Operation(
        summary = "Get Version Type List",
        description = "Retrieve a list of version types"
    )
    @ApiResponse(content = @Content(mediaType = "text/json", array = @ArraySchema(schema = @Schema(implementation = SimpleObject.class))), responseCode = "200", description = "Returns a list of version types")
    @ApiResponse(content = @Content(mediaType = "text/json", schema = @Schema(implementation = ResponseCode.class)), responseCode = "500", description = "Internal error while getting version type list")
    ...
    @Operation(
        summary = "Get Version Status List",
        description = "Retrieve a list of version statuses"
    )
    @ApiResponse(content = @Content(mediaType = "text/json", array = @ArraySchema(schema = @Schema(implementation = SimpleObject.class))), responseCode = "200", description = "Returns a list of version statuses")
    @ApiResponse(content = @Content(mediaType = "text/json", schema = @Schema(implementation = ResponseCode.class)), responseCode = "500", description = "Internal error while getting version status list")
    ...
    @Operation(
        summary = "Reset Problem for Program Ids",
        description = "Reset the problem list for a list of program IDs"
    )
    @io.swagger.v3.oas.annotations.parameters.RequestBody(
...
//    }
    ...
    @Operation(
        summary = "Get Shipment Sync List",
    ...
    @Operation(
        ...
        description = "Check for newer versions for a list of program IDs and versions"
    )
    @io.swagger.v3.oas.annotations.parameters.RequestBody(
