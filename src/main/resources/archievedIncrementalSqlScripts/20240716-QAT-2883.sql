...
INSERT INTO fasp.ap_static_label(STATIC_LABEL_ID,LABEL_CODE,ACTIVE) VALUES ( NULL,'static.funderType.funderTypeText','1');

SELECT MAX(l.STATIC_LABEL_ID) INTO @MAX FROM ap_static_label l ;

INSERT INTO ap_static_label_languages VALUES(NULL,@MAX,1,'Funding Source Type is required');-- en

INSERT INTO ap_static_label_languages VALUES(NULL,@MAX,2,'Le type de source de financement est requis');-- fr

INSERT INTO ap_static_label_languages VALUES(NULL,@MAX,4,'O tipo de fonte de financiamento é obrigatório');-- pr

INSERT INTO ap_static_label_languages VALUES(NULL,@MAX,3,'Se requiere tipo de fuente de financiamiento');-- sp