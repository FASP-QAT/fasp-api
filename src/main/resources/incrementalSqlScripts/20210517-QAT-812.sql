...
BEGIN
    ...
    FROM 
        ...
        LEFT JOIN mn ON LEFT(mn.MONTH,7) BETWEEN LEFT(DATE_SUB(CONCAT(a3.MIN_TRANS_DATE,'-01'), INTERVAL ppu.MONTHS_IN_FUTURE_FOR_AMC-1 MONTH),7) AND LEFT(DATE_ADD(CONCAT(a3.MAX_TRANS_DATE,'-01'), INTERVAL IF(ppu.MONTHS_IN_PAST_FOR_AMC>60,ppu.MONTHS_IN_PAST_FOR_AMC,60) MONTH),7)
