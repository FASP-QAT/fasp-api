...
delete from rm_problem_report_trans  where rm_problem_report_trans.PROBLEM_REPORT_ID in (4356,800,802,804,852);
delete from rm_problem_report  where rm_problem_report.PROBLEM_REPORT_ID in (4356,800,802,804,852);
