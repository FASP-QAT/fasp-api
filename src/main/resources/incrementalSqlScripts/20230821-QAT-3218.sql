...
CHANGE COLUMN DATA_VALUE DATA_VALUE DECIMAL(24,8) NULL DEFAULT NULL COMMENT 'Based on the forecast_tree_node.NODE_TYPE_ID this value will be used either as a direct value or as a Perc of the Parent' ;
ALTER TABLE fasp.rm_forecast_tree_node_data_mom 
CHANGE COLUMN START_VALUE START_VALUE DECIMAL(24,8) UNSIGNED NOT NULL ,
CHANGE COLUMN END_VALUE END_VALUE DECIMAL(24,8) UNSIGNED NOT NULL ,
CHANGE COLUMN CALCULATED_VALUE CALCULATED_VALUE DECIMAL(24,8) UNSIGNED NOT NULL ,
CHANGE COLUMN CALCULATED_MMD_VALUE CALCULATED_MMD_VALUE DECIMAL(24,8) UNSIGNED NULL DEFAULT NULL ,
CHANGE COLUMN DIFFERENCE DIFFERENCE DECIMAL(24,8) NULL DEFAULT NULL ,
CHANGE COLUMN MANUAL_CHANGE MANUAL_CHANGE DECIMAL(24,8) NULL DEFAULT NULL ;
...
BEGIN
    ...
    SELECT 
        ...
        SUM(COALESCE(mom.CALCULATED_MMD_VALUE, fced.AMOUNT)) `TOTAL_FORECAST`, dpus.NOTES, pv.FREIGHT_PERC,
