...
SET @programId = VAR_PROGRAM_ID;
    SET @versionId = VAR_VERSION_ID;
        ...
        SUM(o.SHIPMENT) `SHIPMENT`, SUM(o.SHIPMENT_WPS) `SHIPMENT_WPS`, SUM(o.ADJUSTMENT) `ADJUSTMENT`, SUM(o.STOCK) `STOCK`, IF(o.TRANS_ID IS NULL,null ,COALESCE(o.QTY,0)) `INVENTORY_QTY`  
        FROM (
            SELECT 
            ...
            null `SHIPMENT`, null `SHIPMENT_WPS`,null `ADJUSTMENT`, null  `STOCK`, null `INVENTORY_QTY` 
            FROM (
                SELECT 
            ...
            SELECT 
                ...
                null  `ADJUSTMENT_MULTIPLIED_QTY`, null  `STOCK_MULTIPLIED_QTY`, null `INVENTORY_QTY` 
            FROM (
