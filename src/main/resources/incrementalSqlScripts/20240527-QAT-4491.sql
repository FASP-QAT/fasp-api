...
INSERT INTO ap_static_label_languages VALUES(NULL,@MAX,1,') will go over budget by $');-- en
INSERT INTO ap_static_label_languages VALUES(NULL,@MAX,2,') dépassera le budget de $');-- fr
INSERT INTO ap_static_label_languages VALUES(NULL,@MAX,3,') excederá el presupuesto en $');-- sp
INSERT INTO ap_static_label_languages VALUES(NULL,@MAX,4,') ultrapassará o orçamento em $');-- pr
