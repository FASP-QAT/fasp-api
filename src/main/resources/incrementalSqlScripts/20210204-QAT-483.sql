...
UPDATE `ap_problem` SET ACTUAL_CONSUMPTION_TRIGGER=0, FORECASTED_CONSUMPTION_TRIGGER=1, INVENTORY_TRIGGER=0, ADJUSTMENT_TRIGGER=0, SHIPMENT_TRIGGER=0 WHERE PROBLEM_ID=2;
...
UPDATE `ap_problem` SET ACTUAL_CONSUMPTION_TRIGGER=1, FORECASTED_CONSUMPTION_TRIGGER=1, INVENTORY_TRIGGER=1, ADJUSTMENT_TRIGGER=1, SHIPMENT_TRIGGER=1 WHERE PROBLEM_ID=10;
