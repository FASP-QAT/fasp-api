...
INSERT INTO fasp.ap_static_label(STATIC_LABEL_ID,LABEL_CODE,ACTIVE) VALUES ( NULL,'static.dataentry.otherUnitName','1');
SELECT MAX(l.STATIC_LABEL_ID) INTO @MAX FROM ap_static_label l ;

INSERT INTO ap_static_label_languages VALUES(NULL,@MAX,1,'Enter Other unit name');-- en
INSERT INTO ap_static_label_languages VALUES(NULL,@MAX,2,'Entrez le nom de l`autre unité');-- fr
INSERT INTO ap_static_label_languages VALUES(NULL,@MAX,3,'Ingrese el nombre de otra unidad');-- sp
INSERT INTO ap_static_label_languages VALUES(NULL,@MAX,4,'Digite o nome de outra unidade');-- pr


INSERT INTO fasp.ap_static_label(STATIC_LABEL_ID,LABEL_CODE,ACTIVE) VALUES ( NULL,'static.dataentry.otherUnitMultiplier','1');
SELECT MAX(l.STATIC_LABEL_ID) INTO @MAX FROM ap_static_label l ;

INSERT INTO ap_static_label_languages VALUES(NULL,@MAX,1,'Enter Other unit multiplier');-- en
INSERT INTO ap_static_label_languages VALUES(NULL,@MAX,2,'Entrez Autre multiplicateur d`unité');-- fr
INSERT INTO ap_static_label_languages VALUES(NULL,@MAX,3,'Ingrese el multiplicador de otra unidad');-- sp
INSERT INTO ap_static_label_languages VALUES(NULL,@MAX,4,'Insira outro multiplicador de unidade');-- pr

ALTER TABLE `fasp`.`rm_forecast_tree_node_data_modeling` ADD COLUMN `INCREASE_DECREASE` INT NOT NULL DEFAULT 1 AFTER `DATA_VALUE`;
ALTER TABLE `fasp`.`rm_tree_template_node_data_modeling` ADD COLUMN `INCREASE_DECREASE` INT NOT NULL DEFAULT 1 AFTER `DATA_VALUE`;
