...
BEGIN
    ...
    IF @reportView = 1 THEN
        SELECT
            ...
            GROUP_CONCAT(DISTICT CONCAT(dpus.TREE_ID, '-',dpus.SCENARIO_ID))`TREE_SCENARIO`, fce.EXTRAPOLATION_METHOD_ID, COALESCE(mom.MONTH, fced.MONTH,mn.MONTH) `MONTH`, COALESCE(mom.CALCULATED_MMD_VALUE, fced.AMOUNT) `CALCULATED_MMD_VALUE`
