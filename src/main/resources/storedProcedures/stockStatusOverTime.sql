CREATE DEFINER=`faspUser`@`localhost` PROCEDURE `stockStatusOverTime`(VAR_START_DATE DATE, VAR_STOP_DATE DATE, VAR_PROGRAM_ID INT(10), VAR_VERSION_ID INT, VAR_PLANNING_UNIT_IDS TEXT, VAR_MONTHS_IN_PAST_FOR_AMC INT(10), VAR_MONTHS_IN_FUTURE_FOR_AMC INT(10))
BEGIN
